...
def check_win(symbol: str):
    ...
    check_line(game_field[0][0], game_field[1][1], game_field[2][2], symbol)
    check_line(game_field[2][0], game_field[1][1], game_field[0][2], symbol)
    for i in range(3):
        check_line(game_field[i][0], game_field[i][1], game_field[i][2], symbol)
        check_line(game_field[0][i], game_field[1][i], game_field[2][i], symbol)
